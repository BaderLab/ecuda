...
public:
    ...
    __HOST__ __DEVICE__ striding_ptr(striding_ptr&& src)
    ...
    {
        return striding_ptr(*this).operator+=(i).operator*();
    }

    __HOST__ __DEVICE__ inline striding_ptr& operator++()
    {
        ptr += stride;
        return *this;
    }
    ...
    __HOST__ __DEVICE__ inline striding_ptr operator++(int)
    {
    ...
    __HOST__ __DEVICE__ inline striding_ptr& operator+=(int x)
    {
        ptr += x * stride;
        return *this;
    }
    ...
    __HOST__ __DEVICE__ inline striding_ptr operator+(int x) const
    {
        striding_ptr tmp(*this);
        tmp += x;
        return tmp;
    ...
    __HOST__ __DEVICE__ inline bool operator==(const striding_ptr<T2, P2>& other) const
    {
