...
lexicographical_compare(InputIterator1 first1,
                        ...
                        pair<ecuda::false_type, ecuda::false_type>)
{
#ifdef __CUDA_ARCH__
...
lexicographical_compare(InputIterator1 first1,
                        ...
                        InputIterator2 first2,
                        InputIterator2 last2,
                        pair<ecuda::true_type, ecuda::false_type>)
{
#ifdef __CUDA_ARCH__
    return false; // never actually gets called, just here to trick nvcc
#else
    return ::ecuda::lexicographical_compare(
      first2, last2, first1, last1); // switch positions to resolve to function below
#endif
}
...
lexicographical_compare(InputIterator1 first1,
                        ...
                        InputIterator2 first2,
                        InputIterator2 last2,
                        pair<ecuda::false_type, ecuda::true_type>)
{
#ifdef __CUDA_ARCH__
    return false; // never actually gets called, just here to trick nvcc
#else
    typedef typename ecuda::remove_const<typename ecuda::iterator_traits<InputIterator2>::value_type>::type value_type;
    {
        ...
        ECUDA_STATIC_ASSERT(isSomeKindOfContiguous,
...
lexicographical_compare(InputIterator1 first1,
                        ...
                        InputIterator2 first2,
                        InputIterator2 last2,
                        pair<ecuda::true_type, ecuda::true_type> // compare device to device
)
{
#ifdef __CUDA_ARCH__
...
lexicographical_compare(InputIterator1 first1, InputIterator1 last1, InputIterator2 first2, InputIterator2 last2)
{
    return impl::lexicographical_compare(first1,
                                         last1,
                                         first2,
                                         last2,
                                         pair<typename ecuda::iterator_traits<InputIterator1>::is_device_iterator,
