...
mismatch(InputIterator1 first1,
         ...
         ecuda::pair<ecuda::false_type, ecuda::false_type>) // host/host memory
{
#ifdef __CUDA_ARCH__
...
mismatch(InputIterator1 first1,
         InputIterator1 last1,
         InputIterator2 first2,
         ecuda::pair<ecuda::false_type, ecuda::true_type>) // host/device memory
{
#ifdef __CUDA_ARCH__
    return ecuda::pair<InputIterator1, InputIterator2>(first1, first2); // never called from device code
#else
...
mismatch(InputIterator1 first1,
         InputIterator1 last1,
         InputIterator2 first2,
         ecuda::pair<ecuda::true_type, ecuda::false_type>) // device/host memory
{
#ifdef __CUDA_ARCH__
    return ecuda::pair<InputIterator1, InputIterator2>(first1, first2); // never called from device code
#else
    ...
    ecuda::pair<InputIterator2, InputIterator1> p =
      mismatch(first2, last2, first1, ecuda::pair<ecuda::false_type, ecuda::true_type>());
...
mismatch(InputIterator1 first1,
         InputIterator1 last1,
         InputIterator2 first2,
         ecuda::pair<ecuda::true_type, ecuda::true_type>) // device/device memory
{
#ifdef __CUDA_ARCH__
    ...
    std::pair<typename vector_type1::iterator, typename vector_type2::iterator> p =
