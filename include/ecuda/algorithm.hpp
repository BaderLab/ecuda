...
__HOST__ __DEVICE__ inline UnaryFunction
for_each( InputIterator first, InputIterator last, UnaryFunction f, std::false_type )
{
	#ifdef __CUDA_ARCH__
...
template<class InputIterator,class UnaryFunction>
__HOST__ __DEVICE__ inline UnaryFunction
for_each( InputIterator first, InputIterator last, UnaryFunction f, std::true_type )
{
	#ifdef __CUDA_ARCH__
...
count( InputIterator first, InputIterator last, const T& value, std::false_type )
{
	#ifdef __CUDA_ARCH__
...
template<class InputIterator,typename T>
__HOST__ __DEVICE__ inline typename ecuda::iterator_traits<InputIterator>::difference_type
count( InputIterator first, InputIterator last, const T& value, std::true_type )
{
	#ifdef __CUDA_ARCH__
...
template<class InputIterator,class UnaryPredicate>
__HOST__ __DEVICE__ inline typename ecuda::iterator_traits<InputIterator>::difference_type
count_if( InputIterator first, InputIterator last, UnaryPredicate p, std::false_type )
{
	#ifdef __CUDA_ARCH__
	return 0; // never called from device code
	#else
...
template<class InputIterator,class UnaryPredicate>
__HOST__ __DEVICE__ inline typename ecuda::iterator_traits<InputIterator>::difference_type
count_if( InputIterator first, InputIterator last, UnaryPredicate p, std::true_type )
{
	#ifdef __CUDA_ARCH__
	typename ecuda::iterator_traits<InputIterator>::difference_type n = 0;
	while( first != last ) {
